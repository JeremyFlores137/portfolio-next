  ...
  return (
    <>
      ...
      <section className='flex w-full items-center justify-between lg:flex-col'>
        ...
        <div className='flex w-1/2 flex-col items-center self-center 2xl:ml-5 xl:ml-0 lg:w-full lg:text-center xs:mt-5'>
          <Presentation
            text='Convirtiendo Obstáculos en Sólidos Escalones hacia el Progreso'
            className='!text-6x1 !text-left
          !normal-case  dark:text-white/90 3xl:!ml-2 xl:!ml-0 xl:!text-6xl lg:!text-center lg:!text-5xl md:!text-4xl
          sm:!text-3xl
          '
          />
          <p className='my-4 text-base font-medium 3xl:ml-2 2xl:ml-2 xl:ml-0 md:text-sm sm:text-sm xs:mb-6
          dark:text-white/80'>
          ...
          <div className='mr-auto flex items-center justify-center gap-2 3xl:mt-8 xl:mt-0 lg:m-auto lg:mb-20 lg:flex-col'>
            ...
            lg:m-auto lg:my-3 lg:text-lg md:p-3 md:text-lg xs:p-2 xs:px-8 xs:text-xs
            '
            >
              Mi Curriculum
            </a>
