  ...
  return (
    <>
      ...
      <section className='flex w-full items-center justify-between lg:flex-col'>
        ...
        <div className='flex w-1/2 flex-col items-center self-center 3xl:ml-2 2xl:mx-5 xl:ml-0 lg:mx-0 lg:w-full lg:text-center xs:mt-5'>
          <Presentation
          ...
          />
          <p
            className='my-4 text-base font-medium dark:text-white/80 3xl:mr-auto 2xl:ml-2 xl:ml-0 md:text-sm sm:text-sm
          xs:mb-6'
          >
          ...
          <div className='mr-auto flex items-center justify-center gap-2 3xl:mt-8 xl:mt-0 lg:m-auto lg:mb-20 lg:flex-col'>
            ...
            xl:text-xl lg:m-auto lg:my-3 lg:text-lg md:p-4 md:text-lg xs:p-4 xs:px-8
            '
            >
              Mi Curriculum
            </a>
